...
export default async function FinancePage() {
  ...
  return <>
    <div className="pageHeader"><div><p className="eyebrow">{now.toLocaleDateString("en-GB", { month: "long", year: "numeric" })}</p><h1>Monthly finance</h1><p className="lede">Live hotel revenue, payroll, commissions and approved show expenses.</p></div></div>
    <div className="grid4">
      <div className="card metric"><div className="metricLabel">Revenue</div><div className="metricValue">{format(calculation?.revenue ?? 0)}</div><div className="metricMeta">Completed performances</div></div>
    ...
    <section className="card section"><div className="sectionHeader"><h2>Hotel billing</h2></div><div className="sectionBody tableWrap"><table><thead><tr><th>Hotel</th><th className="num">Completed performances</th><th className="num">Invoice amount</th></tr></thead><tbody>
      ...
      {!hotelTotals.size && <tr><td colSpan={3}><div className="emptyState">No completed, rated performances in this month.</div></td></tr>}
