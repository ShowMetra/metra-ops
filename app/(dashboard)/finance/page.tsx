...
export default async function FinancePage() {
  ...
  return <>
    <div className="pageHeader"><div><p className="eyebrow">{now.toLocaleDateString("en-GB", { month: "long", year: "numeric" })}</p><h1>Monthly finance</h1><p className="lede">Revenue, payroll, commissions and approved expenses from automatically finished calendar entries.</p></div></div>
    <div className="grid4">
    ...
    <section className="card section"><div className="sectionHeader"><h2>Hotel billing</h2></div><div className="sectionBody tableWrap"><table><thead><tr><th>Hotel</th><th className="num">Finished performances</th><th className="num">Invoice amount</th></tr></thead><tbody>
      ...
      {!hotelTotals.size && <tr><td colSpan={3}><div className="emptyState">No finished, rated performances in this month.</div></td></tr>}
